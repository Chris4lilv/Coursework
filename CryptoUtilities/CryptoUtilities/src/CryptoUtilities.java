...
public final class CryptoUtilities {
    ...
    public static void reduceToGCD(NaturalNumber n, NaturalNumber m) {
        ...
        if (m.compareTo(new NaturalNumber1L(0)) == 0) {
            m.clear();
        } else {
            if (n.compareTo(m) > 0) {
                n.subtract(m);
    ...
    public static boolean isWitnessToCompositeness(NaturalNumber w,
        ...
        NaturalNumber temp = new NaturalNumber1L(w);
        ...
        return ((w.canConvertToInt() && (w.toInt() == 1))
                || (temp.canConvertToInt() && (temp.toInt() != 1)));
    }
    ...
    public static boolean isPrime2(NaturalNumber n) {
        ...
        for (int i = 0; i < 50; i++) {
            ...
            NaturalNumber n1 = new NaturalNumber1L(n);
            n1.decrement();
            if (random.compareTo(n1) < 0
                    && random.compareTo(new NaturalNumber1L(1)) > 0) {
