...
public abstract class ProgramTest {
    ...
    /**
     * The name of a file containing a BL program that contains empty context.
     */
    private static final String PROGRAM_EMPTY_CONTEXT = "data/program-empty-context.bl";

    /**
     * The name of a file containing a BL program that contains empty context.
     */
    private static final String PROGRAM_EMPTY_BODY = "data/program-empty-body.bl";
    ...
    /**
     * Test newContext when context is not empty.
     */
    @Test
    public final void testNewContextNonEmpty() {
        /*
         * Setup
         */
        Program pTest = this.createFromFileTest(FILE_NAME_1);
    ...
    public final void testNewContextEmpty() {
         ...
         * Setup
         */
        Program pTest = this.createFromFileTest(PROGRAM_EMPTY_CONTEXT);
        Program pRef = this.createFromFileRef(PROGRAM_EMPTY_CONTEXT);
        Map<String, Statement> cRef = pRef.newContext();
    ...
    /**
     * Test newBody when body is not empty.
     */
    @Test
    public final void testNewBodyNonEmpty() {
        /*
         * Setup
         */
        Program pTest = this.createFromFileTest(FILE_NAME_1);
    ...
    public final void testNewBodyEmpty() {
         ...
         * Setup
         */
        Program pTest = this.createFromFileTest(PROGRAM_EMPTY_BODY);
        Program pRef = this.createFromFileRef(PROGRAM_EMPTY_BODY);
        Statement bRef = pRef.newBody();
