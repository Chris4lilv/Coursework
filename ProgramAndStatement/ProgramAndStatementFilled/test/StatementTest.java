...
public abstract class StatementTest {
    ...
    /**
     * The name of a file containing a sequence of BL statements that has no
     * block.
     */
    private static final String LENGTH_OF_BLOCK_ZERO = "data/statement-empty.bl";

    /**
     * The name of a file containing a sequence of BL statements that has one
     * block.
     */
    private static final String REMOVE_LEAVE_EMPTY = "data/statement-remove-leave-empty.bl";
    ...
    /**
     * Test addToBlock at the end.
     */
    @Test
    public final void testAddToBlockBack() {
        /*
         * Setup
         */
        Statement sTest = this.createFromFileTest(FILE_NAME_1);
        ...
        Statement nestedTest = sTest.removeFromBlock(1);
        Statement nestedRef = sRef.removeFromBlock(1);
        sRef.addToBlock(sTest.lengthOfBlock(), nestedRef);
    ...
    public final void testRemoveFromBlockFrontLeavingEmpty() {
         ...
         * Setup
         */
        Statement sTest = this.createFromFileTest(REMOVE_LEAVE_EMPTY);
        Statement sRef = this.createFromFileRef(REMOVE_LEAVE_EMPTY);
        Statement nestedRef = sRef.removeFromBlock(0);
    ...
    /**
     * Test lengthOfBlock, when it's zero.
     */
    @Test
    public final void testLengthOfBlockEmpty() {
         ...
         * Setup
         */
        Statement sTest = this.createFromFileTest(LENGTH_OF_BLOCK_ZERO);
        Statement sRef = this.createFromFileRef(LENGTH_OF_BLOCK_ZERO);
        int lengthRef = sRef.lengthOfBlock();
