...
public abstract class ListTest {
    ...
    /**
     * Testing a routine case of retreat.
     */
    @Test
    ...
    /**
     * Testing case where the resulting left length would be 0.
     */
    @Test
    public final void testRetreat2() {
        List<String> list1 = this.createFromArgsTest(1, "yellow");
        List<String> list2 = this.createFromArgsRef(1, "yellow");
        list1.retreat();
        list2.retreat();
        assertEquals(list2, list1);
    }
    ...
    /**
     * Testing a case where the left length is mac before the call.
     */
    @Test
    ...
    /**
     * Testing a case where left length would be zero with more data.
     */
    @Test
    ...
    /**
     * Testing new instance with data.
     */
    @Test
    public final void testNewInstance1() {
        ...
        List<String> list2 = this.createFromArgsRef(1, "yellow", "orange",
                "green", "purple");
        List<String> list1new = list1.newInstance();
        List<String> list2new = list2.newInstance();
        assertEquals(list2, list1);
        assertEquals(list2new, list1new);
    }

    /**
     * Testing new instance without data.
     */
    @Test
    public final void testNewInstance2() {
        List<String> list1 = this.constructorTest();
        List<String> list2 = this.constructorRef();
        List<String> list1new = list1.newInstance();
        List<String> list2new = list2.newInstance();
    ...
    /**
     * Testing transfer from with no data.
     */
    @Test
    public final void testTransferFrom1() {
        List<String> list1 = this.constructorTest();
        List<String> list2 = this.constructorRef();
        List<String> list2TF = this.constructorRef();
        List<String> list1TF = this.constructorTest();
        list1.transferFrom(list1TF);
        list2.transferFrom(list2TF);
        assertEquals(list2, list1);
    }

    /**
     * Testing transfer from with initial data.
     */
    @Test
    ...
    /**
     * Testing transfer from with initial data in the transfer.
     */
    @Test
    public final void testTransferFrom3() {
        List<String> list1 = this.constructorTest();
        List<String> list2 = this.constructorRef();
        List<String> list1TF = this.createFromArgsTest(1, "yellow", "orange",
                "green", "purple");
        List<String> list2TF = this.createFromArgsRef(1, "yellow", "orange",
                "green", "purple");
        list1.transferFrom(list1TF);
        list2.transferFrom(list2TF);
        assertEquals(list2, list1);
    ...
    /**
     * Testing transfer from with initial data in both transfer and prev.
     */
    @Test
    public final void testTransferFrom4() {
        List<String> list1 = this.createFromArgsTest(0, "yellow");
