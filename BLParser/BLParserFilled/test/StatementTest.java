...
public abstract class StatementTest {
    ...
    /**
     * Test of parse on valid input with IF-ELSE.
     */
    @Test
    ...
    /**
     * Test of parse on valid input with WHILE inside IF.
     */
    @Test
    ...
    /**
     * Test of parse on invalid input with wrong ending.
     */
    @Test(expected = RuntimeException.class)
    ...
    /**
     * Test of parse on invalid input with missing IF in front of ELSE.
     */
    @Test(expected = RuntimeException.class)
