...
public final class Program1Parse1 extends Program1 {
    ...
    public void parse(Queue<String> tokens) {
        ...
        while (tokens.front().equals("INSTRUCTION")) {
            ...
            String instruction = parseInstruction(tokens, body);
            Reporter.assertElseFatalError(!context.hasKey(instruction),
                    "Instruction names can only be used once");
            context.add(instruction, body);
        }
        this.swapContext(context);
        ...
        Reporter.assertElseFatalError(
                tokens.dequeue().equals(programIdentifier),
                "Program identifier mismatch");
        //the length must be 1, because the END OF INPUT string is present
